...
/**
 * RasterSourceHelper.kt
 *
 * Created by Amit Chaudhary, 2022/10/6
 */
internal object RasterSourceHelper {

    /**
     * Method to set properties got from the flutter side to RasterSource.Builder block
     */
    fun blockFromArgs(args: Map<*, *>): RasterSource.Builder.() -> Unit {
